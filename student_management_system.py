...
# set heading
title = Label(root, text="Student Management System", font=("times new roman", 40, "bold"), bg="white", fg="blue")
title.grid(row=0, column=0, columnspan=2, sticky='ew')

# detail frame name "details"
details_frame = LabelFrame(root, text="Student Details", font=("Enter Details", 12, "bold"), bg="white", fg="blue")
details_frame.grid(row=1, column=0, columnspan=2, sticky='nsew')

# label and entry for Roll Number
id_label = Label(details_frame, text="Student ID", font=("Roll Number", 15, "bold"), bg="white", fg="blue", anchor='w')
...
name_label = Label(details_frame, text="Student Name", font=("Name", 15, "bold"), bg="white", fg="blue", anchor='w')
...
gender_label = Label(details_frame, text="Gender", font=("Name", 15, "bold"), bg="white", fg="blue", anchor='w')
...
grade_label = Label(details_frame, text="Grade", font=("Name", 15, "bold"), bg="white", fg="blue", anchor='w')
...
age_label = Label(details_frame, text="Age", font=("Name", 15, "bold"), bg="white", fg="blue", anchor='w')
...
contact_label = Label(details_frame, text="Contact", font=("Name", 15, "bold"), bg="white", fg="blue", anchor='w')
...
# add button
add_btn = Button(btn_frame, text="Add", font=("times new roman", 15, "bold"), bg="blue", fg="white", cursor="hand2", command=add_student)
add_btn.grid(row=0, column=0, padx=20, pady=10, sticky='w')

# view button
view_btn = Button(btn_frame, text="View", font=("times new roman", 15, "bold"), bg="blue", fg="white", cursor="hand2", command=display_students)
view_btn.grid(row=0, column=1, padx=20, pady=10, sticky='w')

# delete button
delete_btn = Button(btn_frame, text="Delete", font=("times new roman", 15, "bold"), bg="blue", fg="white", cursor="hand2", command=delete_student)
delete_btn.grid(row=0, column=2, padx=20, pady=10, sticky='w')

# update button
update_btn = Button(btn_frame, text="Update", font=("times new roman", 15, "bold"), bg="blue", fg="white", cursor="hand2", command=update_student)
update_btn.grid(row=0, column=3, padx=20, pady=10, sticky='w')

# clear button
clear_btn = Button(btn_frame, text="Clear", font=("times new roman", 15, "bold"), bg="blue", fg="white", cursor="hand2", command=clear_entry_and_combobox)
...
search_btn = Button(btn_frame, text="Search", font=("times new roman", 15, "bold"), bg="blue", fg="white", cursor="hand2", command=search_student)
